                ...
                <div className="container py-5">
                    <div className="row justify-content-start">
                        <div className="col-md-5">
                            ...
                            <button className="btn btn-md text-white float-start mb-3" style={{ background: "#479fc8"}}><a href="#" className="text-decoration-none"></a><span style={{fontSize:'14px'}}>Sign up on Quickteller</span></button>
                        </div>
                    </div>
                </div>
            </section>
