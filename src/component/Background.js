                ...
                <div className="container py-5">
                    <div className="row justify-content-start">
                        <div className="col-md-5 ms-2">
                            ...
                            <button className="btn btn-lg text-white float-start mb-3" style={{ background: "#479fc8",fontSize:'14px'}}><Link to='/signup' style={{textDecoration:"none",color:"white"}}>Sign up on Quickteller</Link></button>
                        </div>
                    </div>
                </div>
            </section>
