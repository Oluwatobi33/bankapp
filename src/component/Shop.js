                ...
                <div className="row">
                    <div className="col-lg-6 col-md-6">
                        ...
                        <div className="row">
                            <div className="col-5">
                                <div className='bill'>
                                    <img src='https://www.interswitchgroup.com/assets/images/consumer/Bills-1.svg' className='img-responsive img-fluid ' />
                                    <h3 className='text-md-start'>Bill payments</h3>
                            ...
                            <div className='col-6'>
                                <div className='flight'>
                                    <img src='https://www.interswitchgroup.com/assets/images/consumer/Flight-1.svg' className='img-responsive img-fluid' />
                                    <h3 className='text-md-start'>
                                        Flight booking
                                    </h3>
                        ...
                        <div className="row">
                            <div className="col-6">
                                <div className='ticket'>
                                    <img src="https://www.interswitchgroup.com/assets/images/consumer/Ticket-1.svg" alt="" className='img-responsive img-fluid' />
                            ...
                            <div className="col-6">
                                <div className='global'>
                                    <img src='https://www.interswitchgroup.com/assets/images/consumer/online-shopping-1.svg' className='img-responsive img-fluid' />
                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className=''>
                            <img src={quick} className='img-responsive img-fluid finegirl' style={{ height: '98vh' }} />
                        </div>
                    </div>
                </div>
            </div>
